...
public class CauseOfActionAdditionalDataResponse {
  ...
  private String _object = "CauseOfActionAdditionalDataResponse";
  ...
  public CauseOfActionAdditionalDataResponse() {
  }

  public CauseOfActionAdditionalDataResponse causeOfActionAdditionalDataArray(List<CauseOfActionAdditionalData> causeOfActionAdditionalDataArray) {
  ...
  public CauseOfActionAdditionalDataResponse addCauseOfActionAdditionalDataArrayItem(CauseOfActionAdditionalData causeOfActionAdditionalDataArrayItem) {
  ...
  **/
  ...
  public CauseOfActionAdditionalDataResponse nextPageAPI(URI nextPageAPI) {
  ...
  **/
  ...
  public CauseOfActionAdditionalDataResponse _object(String _object) {
    
    
    if (_object != null && _object.length() < 35) {
      throw new IllegalArgumentException("Invalid value for _object. Length must be greater than or equal to 35.");
    }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "CauseOfActionAdditionalDataResponse", required = true, value = "")
  ...
  public CauseOfActionAdditionalDataResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public CauseOfActionAdditionalDataResponse previousPageAPI(URI previousPageAPI) {
  ...
  **/
  ...
  public CauseOfActionAdditionalDataResponse totalCount(Integer totalCount) {
  ...
  **/
  ...
  public CauseOfActionAdditionalDataResponse totalPages(Integer totalPages) {
  ...
  **/
   ...
   * @return the CauseOfActionAdditionalDataResponse instance itself
   */
  public CauseOfActionAdditionalDataResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CauseOfActionAdditionalDataResponse causeOfActionAdditionalDataResponse = (CauseOfActionAdditionalDataResponse) o;
    return Objects.equals(this.causeOfActionAdditionalDataArray, causeOfActionAdditionalDataResponse.causeOfActionAdditionalDataArray) &&
        Objects.equals(this.nextPageAPI, causeOfActionAdditionalDataResponse.nextPageAPI) &&
        Objects.equals(this._object, causeOfActionAdditionalDataResponse._object) &&
        Objects.equals(this.pageNumber, causeOfActionAdditionalDataResponse.pageNumber) &&
        Objects.equals(this.previousPageAPI, causeOfActionAdditionalDataResponse.previousPageAPI) &&
        Objects.equals(this.totalCount, causeOfActionAdditionalDataResponse.totalCount) &&
        Objects.equals(this.totalPages, causeOfActionAdditionalDataResponse.totalPages)&&
        Objects.equals(this.additionalProperties, causeOfActionAdditionalDataResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(causeOfActionAdditionalDataArray, nextPageAPI, _object, pageNumber, previousPageAPI, totalCount, totalPages, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CauseOfActionAdditionalDataResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CauseOfActionAdditionalDataResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CauseOfActionAdditionalDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CauseOfActionAdditionalDataResponse is not found in the empty JSON string", CauseOfActionAdditionalDataResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CauseOfActionAdditionalDataResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CauseOfActionAdditionalDataResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CauseOfActionAdditionalDataResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CauseOfActionAdditionalDataResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CauseOfActionAdditionalDataResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CauseOfActionAdditionalDataResponse>() {
           @Override
           public void write(JsonWriter out, CauseOfActionAdditionalDataResponse value) throws IOException {
           ...
           @Override
           public CauseOfActionAdditionalDataResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CauseOfActionAdditionalDataResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CauseOfActionAdditionalDataResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CauseOfActionAdditionalDataResponse
  * @throws IOException if the JSON string is invalid with respect to CauseOfActionAdditionalDataResponse
  */
  public static CauseOfActionAdditionalDataResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CauseOfActionAdditionalDataResponse.class);
  }

 /**
  * Convert an instance of CauseOfActionAdditionalDataResponse to an JSON string
  *
  * @return JSON string
  */
