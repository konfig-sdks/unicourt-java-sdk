...
public class CauseOfActionResponse {
  ...
  private List<CauseOfAction> causeOfActionArray = new ArrayList<>();
  ...
  private String _object = "CauseOfActionResponse";
  ...
  public CauseOfActionResponse() {
  }

  public CauseOfActionResponse causeOfActionArray(List<CauseOfAction> causeOfActionArray) {
  ...
  public CauseOfActionResponse addCauseOfActionArrayItem(CauseOfAction causeOfActionArrayItem) {
    this.causeOfActionArray.add(causeOfActionArrayItem);
    return this;
  }

   /**
   * Get causeOfActionArray
   * @return causeOfActionArray
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")

  public List<CauseOfAction> getCauseOfActionArray() {
    return causeOfActionArray;
  }


  public void setCauseOfActionArray(List<CauseOfAction> causeOfActionArray) {
  ...
  public CauseOfActionResponse nextPageAPI(URI nextPageAPI) {
  ...
  **/
  ...
  public CauseOfActionResponse _object(String _object) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "CauseOfActionResponse", required = true, value = "")
  ...
  public CauseOfActionResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public CauseOfActionResponse previousPageAPI(URI previousPageAPI) {
  ...
  **/
  ...
  public CauseOfActionResponse totalCount(Integer totalCount) {
  ...
  **/
  ...
  public CauseOfActionResponse totalPages(Integer totalPages) {
  ...
  **/
   ...
   * @return the CauseOfActionResponse instance itself
   */
  public CauseOfActionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CauseOfActionResponse causeOfActionResponse = (CauseOfActionResponse) o;
    return Objects.equals(this.causeOfActionArray, causeOfActionResponse.causeOfActionArray) &&
        Objects.equals(this.nextPageAPI, causeOfActionResponse.nextPageAPI) &&
        Objects.equals(this._object, causeOfActionResponse._object) &&
        Objects.equals(this.pageNumber, causeOfActionResponse.pageNumber) &&
        Objects.equals(this.previousPageAPI, causeOfActionResponse.previousPageAPI) &&
        Objects.equals(this.totalCount, causeOfActionResponse.totalCount) &&
        Objects.equals(this.totalPages, causeOfActionResponse.totalPages)&&
        Objects.equals(this.additionalProperties, causeOfActionResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(causeOfActionArray, nextPageAPI, _object, pageNumber, previousPageAPI, totalCount, totalPages, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CauseOfActionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CauseOfActionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CauseOfActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CauseOfActionResponse is not found in the empty JSON string", CauseOfActionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CauseOfActionResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraycauseOfActionArray.size(); i++) {
        CauseOfAction.validateJsonObject(jsonArraycauseOfActionArray.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CauseOfActionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CauseOfActionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CauseOfActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CauseOfActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CauseOfActionResponse>() {
           @Override
           public void write(JsonWriter out, CauseOfActionResponse value) throws IOException {
           ...
           @Override
           public CauseOfActionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CauseOfActionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CauseOfActionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CauseOfActionResponse
  * @throws IOException if the JSON string is invalid with respect to CauseOfActionResponse
  */
  public static CauseOfActionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CauseOfActionResponse.class);
  }

 /**
  * Convert an instance of CauseOfActionResponse to an JSON string
  *
  * @return JSON string
  */
