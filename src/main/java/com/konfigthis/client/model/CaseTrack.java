...
public class CaseTrack {
  ...
  private String _object = "CaseTrack";
  ...
  public CaseTrack _case(ModelCase _case) {
  ...
  **/
  ...
  public CaseTrack caseAPI(URI caseAPI) {
  ...
  **/
  ...
  public CaseTrack caseId(String caseId) {
  ...
  **/
  ...
  public CaseTrack lastFetchDate(OffsetDateTime lastFetchDate) {
  ...
  **/
  ...
  public CaseTrack lastFetchDateWithUpdates(OffsetDateTime lastFetchDateWithUpdates) {
  ...
  **/
  ...
  public CaseTrack lastTrackedDetails(LastTrackedDetails lastTrackedDetails) {
  ...
  **/
  ...
  public CaseTrack _object(String _object) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "CaseTrack", required = true, value = "Name of the object.")
  ...
  public CaseTrack pacerOptions(CaseUpdatePacerOptionsResponse pacerOptions) {
  ...
  **/
  ...
  public CaseTrack schedule(Schedule schedule) {
  ...
  **/
   ...
   * @return the CaseTrack instance itself
   */
  public CaseTrack putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CaseTrack caseTrack = (CaseTrack) o;
    return Objects.equals(this._case, caseTrack._case) &&
        Objects.equals(this.caseAPI, caseTrack.caseAPI) &&
        Objects.equals(this.caseId, caseTrack.caseId) &&
        Objects.equals(this.lastFetchDate, caseTrack.lastFetchDate) &&
        Objects.equals(this.lastFetchDateWithUpdates, caseTrack.lastFetchDateWithUpdates) &&
        Objects.equals(this.lastTrackedDetails, caseTrack.lastTrackedDetails) &&
        Objects.equals(this._object, caseTrack._object) &&
        Objects.equals(this.pacerOptions, caseTrack.pacerOptions) &&
        Objects.equals(this.schedule, caseTrack.schedule)&&
        Objects.equals(this.additionalProperties, caseTrack.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_case, caseAPI, caseId, lastFetchDate, lastFetchDateWithUpdates, lastTrackedDetails, _object, pacerOptions, schedule, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CaseTrack {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CaseTrack
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CaseTrack.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CaseTrack is not found in the empty JSON string", CaseTrack.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CaseTrack.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CaseTrack.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CaseTrack' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CaseTrack> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CaseTrack.class));

       return (TypeAdapter<T>) new TypeAdapter<CaseTrack>() {
           @Override
           public void write(JsonWriter out, CaseTrack value) throws IOException {
           ...
           @Override
           public CaseTrack read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CaseTrack instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CaseTrack given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CaseTrack
  * @throws IOException if the JSON string is invalid with respect to CaseTrack
  */
  public static CaseTrack fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CaseTrack.class);
  }

 /**
  * Convert an instance of CaseTrack to an JSON string
  *
  * @return JSON string
  */
