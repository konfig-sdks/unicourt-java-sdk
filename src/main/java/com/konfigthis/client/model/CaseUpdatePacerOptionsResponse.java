...
import com.konfigthis.client.model.CaseUpdatePacerOptionsResponseAdditionalPageArrayInner;
...
public class CaseUpdatePacerOptionsResponse {
  ...
  private List<CaseUpdatePacerOptionsResponseAdditionalPageArrayInner> additionalPageArray = new ArrayList<>();
  ...
  private String _object = "CaseUpdatePacerOptionsResponse";
 ...
 public enum RefreshTypeEnum {
  ...
  public CaseUpdatePacerOptionsResponse() {
  }

  public CaseUpdatePacerOptionsResponse additionalPageArray(List<CaseUpdatePacerOptionsResponseAdditionalPageArrayInner> additionalPageArray) {
  ...
  public CaseUpdatePacerOptionsResponse addAdditionalPageArrayItem(CaseUpdatePacerOptionsResponseAdditionalPageArrayInner additionalPageArrayItem) {
  ...
  **/
  ...
  @ApiModelProperty(example = "[{\"fetchIfOlderThanDays\":30,\"page\":\"associatedCases\"},{\"fetchIfOlderThanDays\":15,\"page\":\"caseSummary\"},{\"fetchIfOlderThanDays\":15,\"page\":\"listOfCreditors\"}]", required = true, value = "Currently this option is only applicable for Federal PACER cases. The default behavior of the Case Update is to fetch the Docket Report from PACER which includes the parties and attorneys too.  However if you need to fetch information for other pages in PACER you will need to specify it here. - associatedCases: > This will fetch the Associated Cases page in PACER if available. This page consists of related cases especially applicable for Multi-District Litigation cases and Member Cases. Including this option will internally link all related cases in our system. Data from this page will be available via the Related Cases API. - caseSummary: > This will fetch the Case Summary page in PACER if available. This page consists of additional case info which is not present in the Docket Report page. Data from this page will be structured and available as response in the Case API’s ```additional_info``` field. - listOfCreditors: > This page will fetch the “List Of Creditors” page for PACER Bankruptcy cases of case type \"bk\". Note that this page cannot be extracted for Bankruptcy cases of case type \"ap\" (Adversary Proceedings). This page consists of the Creditor information like the name and address of the Creditors. Data from this page will be structured and available as response in the Case API. ")

  public List<CaseUpdatePacerOptionsResponseAdditionalPageArrayInner> getAdditionalPageArray() {
    return additionalPageArray;
  }


  public void setAdditionalPageArray(List<CaseUpdatePacerOptionsResponseAdditionalPageArrayInner> additionalPageArray) {
  ...
  public CaseUpdatePacerOptionsResponse fetchParticipantsIfOlderThanDays(Integer fetchParticipantsIfOlderThanDays) {
  ...
  **/
  ...
  @ApiModelProperty(example = "30", required = true, value = "**Currently this option is only applicable for Federal PACER cases. You can limit how often parties and attorneys for a PACER case are fetched to reduce your PACER fees. If you are tracking cases daily or hourly you could easily end up with a large PACER bill.**  **Use Case: Cases are typically updated to check for new docket entry filings. However every update to PACER case costs money. Participants for a case change less often than docket entry filings. So fetching participants for every update might result in unnecessary PACER costs; especially on cases which have a lot of parties and attorneys. So instead of getting charged the minimum cost of $0.10 for an update which might have had few docket entries, you could end up spending $3 for every update because there were a lot of parties for that case that were also fetched.**  **With this option you can choose when to fetch parties for case based on when was it last fetched.** You can limit how often this participants are fetched in a PACER case to keep your PACER costs under control.  Min days is 0 and Max days is 100.  Example: 1.  Specifying a value of 0 ensures that participants are fetched from PACER for this case update irrespective of when the participants were last fetched. 2.  Specifying a value of 30 ensures that participants are fetched from PACER for this case update only if the last fetch was older than 30 days. ")
  ...
  public CaseUpdatePacerOptionsResponse _object(String _object) {
    
    
    if (_object != null && _object.length() < 30) {
      throw new IllegalArgumentException("Invalid value for _object. Length must be greater than or equal to 30.");
    }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "CaseUpdatePacerOptionsResponse", required = true, value = "Name of the object.")
  ...
  public CaseUpdatePacerOptionsResponse pacerClientCode(String pacerClientCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Test UniCourt API", required = true, value = "PACER Client Code. This is mandatory if your setting in PACER website is set to True for required client code.")
  ...
  public CaseUpdatePacerOptionsResponse pacerUserId(String pacerUserId) {
  ...
  **/
  ...
  public CaseUpdatePacerOptionsResponse refreshType(RefreshTypeEnum refreshType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "FETCHNEWDOCKETENTRIES", required = true, value = "This flag determines whether to pull only new or pull all the docket entries for a PACER case being requested.  Only one of the two values is allowed: -   fetchNewDocketEntries:     >   Updates the PACER case with only new docket entries that have been added after the previous update of the case being requested. -   fetchAllDocketEntries:     >   Updates the PACER case by re-parsing all dockets from #1 till latest docket entry available. ")
   ...
   * @return the CaseUpdatePacerOptionsResponse instance itself
   */
  public CaseUpdatePacerOptionsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CaseUpdatePacerOptionsResponse caseUpdatePacerOptionsResponse = (CaseUpdatePacerOptionsResponse) o;
    return Objects.equals(this.additionalPageArray, caseUpdatePacerOptionsResponse.additionalPageArray) &&
        Objects.equals(this.fetchParticipantsIfOlderThanDays, caseUpdatePacerOptionsResponse.fetchParticipantsIfOlderThanDays) &&
        Objects.equals(this._object, caseUpdatePacerOptionsResponse._object) &&
        Objects.equals(this.pacerClientCode, caseUpdatePacerOptionsResponse.pacerClientCode) &&
        Objects.equals(this.pacerUserId, caseUpdatePacerOptionsResponse.pacerUserId) &&
        Objects.equals(this.refreshType, caseUpdatePacerOptionsResponse.refreshType)&&
        Objects.equals(this.additionalProperties, caseUpdatePacerOptionsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalPageArray, fetchParticipantsIfOlderThanDays, _object, pacerClientCode, pacerUserId, refreshType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CaseUpdatePacerOptionsResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("additionalPageArray");
    openapiRequiredFields.add("fetchParticipantsIfOlderThanDays");
    openapiRequiredFields.add("object");
    openapiRequiredFields.add("pacerClientCode");
    openapiRequiredFields.add("pacerUserId");
    openapiRequiredFields.add("refreshType");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CaseUpdatePacerOptionsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CaseUpdatePacerOptionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CaseUpdatePacerOptionsResponse is not found in the empty JSON string", CaseUpdatePacerOptionsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CaseUpdatePacerOptionsResponse.openapiRequiredFields) {
      ...
      // validate the required field `additionalPageArray` (array)
      for (int i = 0; i < jsonArrayadditionalPageArray.size(); i++) {
        CaseUpdatePacerOptionsResponseAdditionalPageArrayInner.validateJsonObject(jsonArrayadditionalPageArray.get(i).getAsJsonObject());
      };
      if (!jsonObj.get("object").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `object` to be a primitive type in the JSON string but got `%s`", jsonObj.get("object").toString()));
      }
      if (!jsonObj.get("pacerClientCode").isJsonNull() && !jsonObj.get("pacerClientCode").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("refreshType").isJsonNull() && !jsonObj.get("refreshType").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CaseUpdatePacerOptionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CaseUpdatePacerOptionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CaseUpdatePacerOptionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CaseUpdatePacerOptionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CaseUpdatePacerOptionsResponse>() {
           @Override
           public void write(JsonWriter out, CaseUpdatePacerOptionsResponse value) throws IOException {
           ...
           @Override
           public CaseUpdatePacerOptionsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CaseUpdatePacerOptionsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CaseUpdatePacerOptionsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CaseUpdatePacerOptionsResponse
  * @throws IOException if the JSON string is invalid with respect to CaseUpdatePacerOptionsResponse
  */
  public static CaseUpdatePacerOptionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CaseUpdatePacerOptionsResponse.class);
  }

 /**
  * Convert an instance of CaseUpdatePacerOptionsResponse to an JSON string
  *
  * @return JSON string
  */
